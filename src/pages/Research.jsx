...
function Research() {
  ...
  const publications=[
    {title: "Community-aware evolution similarity for link prediction in dynamic social networks",authors: "N. Choudhury",venue: "Mathematics",year: "2024",type: "Journal",link: "https://www.mdpi.com/2227-7390/12/2/285"},
    {title: "Evolutionary Features for Dynamic Link Prediction in Social Networks",authors: "N. Choudhury,Shahadat Uddin",venue: "Applied Sciences",year: "2023",type: "Journal",link: "https://www.mdpi.com/2076-3417/13/5/2913"},
    {title: "Evaluation of an interactive computer-enabled tabletop learning tool for children with special needs",authors: "N. Choudhury,Nazmul Hasan,Muhammad Nazrul Islam",venue: "Journal of Educational Computing Research",year: "2023",type: "Journal",link: "https://journals.sagepub.com/doi/abs/10.1177/07356331221105396"},
    {title: "Do API migrations revert commits? A preliminary investigation",authors: "N. Choudhury,Omar Meqdadi",venue: "IEEE UEMCON",year: "2023",type: "Conference",link: "https://ieeexplore.ieee.org/document/10424276"},
    {title: "Matrix multiplication with diagonals: Structured sparse matrices and beyond",authors: "N. Choudhury,Sardar Anisul Haque,Shahadat Hossain",venue: "HP3C",year: "2023",type: "Conference",link: "https://ieeexplore.ieee.org/document/10205335"},
    {title: "Cryptocurrency: Is it the Future of Payments?",authors: "N. Choudhury,Zachary Mineau,Dylan Hoffman,Jonathan Lor",venue: "Springer book chapter,Cybersecurity for Smart Cities",year: "2023",type: "Book Chapter",link: "https://link.springer.com/chapter/10.1007/978-3-031-24946-4_12"},
    {title: "Ransomware: A Threat to Cyber Smart Cities",authors: "N. Choudhury,Cole Lamers,Eric Spoerl,Garrit Levey,Mohiuddin Ahmed",venue: "Springer book chapter,Cybersecurity for Smart Cities",year: "2023",type: "Book Chapter",link: "https://link.springer.com/chapter/10.1007/978-3-031-24946-4_13"}
  ];
  ...
  const collaborations=[
    {collaborator: "Dr. Todd Hillhouse",institution: "UW–Green Bay,Psychology",topic: "Joint project on mobile application–based intoxication detection,combining AI with cognitive/behavioral data",location: "United States"},
    {collaborator: "Dr. Omar Meqdadi",institution: "UW–Green Bay,Computer Science",topic: "Research on software engineering and API migration,including IEEE UEMCON 2023 publication",location: "United States"},
    {collaborator: "Dr. Muhammad Nazrul Islam",institution: "MIST,Bangladesh",topic: "Long-standing collaboration on Human-Computer Interaction and social media UI design,with joint publications on educational technologies",location: "Bangladesh"},
    {collaborator: "Dr. Sarder Anisul Hoque",institution: "Liverpool John Moores University,Qatar campus",topic: "Work on high-performance computing and sparse matrix multiplication (e.g.,HP3C 2023)",location: "Qatar"},
    {collaborator: "Dr. Shafayat Haque",institution: "Independent researcher,Bangladesh",topic: "Co-author on structured sparse matrix research",location: "Bangladesh"}
  ];
        ...
        <AccordionSection title="Research Areas" icon={FiTarget} defaultOpen={true}>
          <div className="grid gap-6 md:grid-cols-2">
            {researchAreas.map((area,index)=> (
              <div key={index} className="p-6 border border-purple-200 rounded-lg transition-all duration-300 hover:border-purple-400 hover:shadow-lg hover:shadow-purple-100 hover:-translate-y-1 cursor-pointer group">
          ...
          <div className="space-y-6">
            {publications.map((pub,index)=> (
              <div key={index} className="p-6 bg-purple-50 rounded-lg">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <a href={pub.link} className="text-purple-600 hover:text-purple-900 transition-colors" target="_blank" rel="noopener noreferrer">
            ...
            <div className="mt-6 p-4 bg-purple-100 rounded-lg text-center">
              <p className="text-purple-700">
                ...
                <a href="https://scholar.google.com/citations?user=bcTAO-wAAAAJ&hl=en&inst=16730761618876726293" target="_blank" rel="noopener noreferrer" className="text-purple-900 font-medium hover:text-purple-700 underline transition-colors">
                  Google Scholar
                </a>
              </p>
            </div>
