  ...
  const contactInfo = [
    {
      icon: FiMail,
      label: "Email",
      value: "choudhun@uwgb.edu",
      link: "mailto:choudhun@uwgb.edu"
    },
    {
      icon: FiPhone,
      label: "Phone",
  ...
  const socialLinks = [
    {
      ...
      url: "https://scholar.google.com/citations?user=bcTAO-wAAAAJ&hl=en&inst=16730761618876726293",
      customIcon: "https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1758229060782-Google_Scholar_logo.png"
    },
    {
      icon: null,
      label: "LinkedIn",
      url: "https://www.linkedin.com/in/nazim-choudhury-5a673a3b/",
      customIcon: "https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1758229174957-linkedin%20logo.png"
    },
    {
      icon: null,
      label: "ResearchGate",
      url: "https://www.researchgate.net/profile/Nazim-Choudhury",
      customIcon: "https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1758229239640-research%20gate%20logo.png"
    }
  ];
