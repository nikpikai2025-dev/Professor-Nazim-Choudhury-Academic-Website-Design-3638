  ...
  const teachingApproach = [
    {
      ...
      description: "Emphasis on student engagement through problem-based projects and collaborative teamwork to enhance understanding and retention."
    },
    {
      title: "Theory to Practice",
      description: "Connecting theoretical concepts to real-world applications through case studies and professional scenarios."
    },
    {
      title: "Open-Door Approach",
      description: "Creating an accessible learning environment where students feel comfortable seeking help and engaging in discussions."
    },
    {
      title: "Partnership Learning",
      description: "Viewing education as a collaborative partnership where students are respected, engaged, and challenged to grow."
    }
  ];
